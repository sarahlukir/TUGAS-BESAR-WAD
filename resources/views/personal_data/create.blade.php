<x-app-layout>
    <div class="container mx-auto max-w-7xl py-12 sm:px-6 lg:px-8">
        <h2 class="mb-4 text-xl font-semibold">Tambah Data Diri</h2>
        ...
        <form action="{{ route('personal_data.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="job_title" id="job_title"
                    class="mt-2 w-full rounded-md border border-gray-300 p-2" value="{{ old('job_title') }}" required>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="company_name" id="company_name"
                    class="mt-2 w-full rounded-md border border-gray-300 p-2" value="{{ old('company_name') }}"
                    required>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="location" id="location"
                    class="mt-2 w-full rounded-md border border-gray-300 p-2" value="{{ old('location') }}" required>
            ...
            <div class="mb-4">
                ...
                <input type="date" name="start_date" id="start_date"
                    class="mt-2 w-full rounded-md border border-gray-300 p-2" value="{{ old('start_date') }}" required>
            ...
            <div class="mb-4">
                ...
                <input type="date" name="end_date" id="end_date"
                    class="mt-2 w-full rounded-md border border-gray-300 p-2" value="{{ old('end_date') }}">
            ...
            <div class="mb-4">
                ...
                <select name="is_working" id="is_working" class="mt-2 w-full rounded-md border border-gray-300 p-2"
                    required>
                    <option value="1" {{ old('is_working') == '1' ? 'selected' : '' }}>Ya</option>
                    <option value="0" {{ old('is_working') == '0' ? 'selected' : '' }}>Tidak</option>
                </select>
